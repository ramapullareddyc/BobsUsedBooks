...
namespace Bookstore.Data
{
    public partial class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Configure column names for Address
            ...
            modelBuilder.Entity<Book>().Ignore(e => e.IsInStock);
            modelBuilder.Entity<Book>().Ignore(e => e.IsLowInStock);

            // Configure column names for Customer
            ...
            // Configure column names for Order
            ...
            // Configure column names for ShoppingCart
            ...
            // Configure column names for ShoppingCartItem
            ...
            // Configure column names for OrderItem
            ...
            // Configure column names for Offer
            ...
            // Configure column names for ReferenceDataItem
